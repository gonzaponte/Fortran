...
!
!O programa coeficientes calcula os valores medios das constantes do sistema calculados aqueles
!polo programa dinamica. Tamén calcula outras constantes así como o erro de tódalas constantes.
!
!O de sempre, defino precisións e afirmo que non hai variables implícitas.
!
use prec
implicit none
!
...
!
!Leo o ficheiro de constantes do sistema e asigno os valores ás variables do programa. Saltareime
!a primeira liña de valores porque da un dato moi malo para kS e fai que a incerteza sexa despro-
!porcionada, de todos xeitos ao ter feitas 21 simulacións non é tan relevante como con 10.
!
open(20,file='Constantes.dat')
	read (20,8004) Temp(1),Presion(1),alphaE(1),Cv(1),gamma(1),kS(1) !Para saltarme os primeiros datos.
	do i=1,nint(x)
...
!
!Gardo os valores  nun arquivo en ASCII.
!
open(30,file='Coef_termo.dat')
    ...
    write(30,*)
    write(30,*) 'Número total de datos usados: ',nint(x)
close(30)
!
!Fin.
!
