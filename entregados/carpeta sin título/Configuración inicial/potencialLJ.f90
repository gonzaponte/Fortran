...
!Defino as variables de entrada:
...
do i=1,N-1
  do j=i+1,N
    ...
    if (D2<=Rc2) then
      ...
      phiv=phiv-2*D12+D6      !Primeira derivada
      phivv=phivv+26*D12-7*D6 !Segunda derivada
...
Deltaphiv=cor*(1-2*Rc6/3)
phiv=(24*phiv+Deltaphiv)*L33

Deltaphivv=cor*(26*Rc6/3-7)
phivv=((24*phivv+Deltaphivv)*L33-2*phiv)*L33
